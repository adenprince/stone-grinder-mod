...
public class GrindingRecipe extends AbstractCookingRecipe {
    public GrindingRecipe(Identifier id, String group, CookingRecipeCategory category, Ingredient input,
                          ItemStack output, float experience, int cookTime) {
        super(ModRecipes.GRINDING_RECIPE_TYPE, id, group, category, input, output, experience, cookTime);
    }
